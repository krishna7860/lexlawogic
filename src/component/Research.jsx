...
export class Research extends Component {
  render() {
    return (
      <div>
      <h1 className='bg-dark text-light my-3 p-2 text-center '>Research Papers</h1>
    <div className=' d-flex justify-content-center'>
     <div className='col-8'>
      <Card tags='RESEARCH PAPERS'/>
    ...
    <div classname='col-4'>
      ...
      <div className='mx-2' style={{ width: '300px' }}>
        <div className='badge badge-dark py-3 px-5 my-3'>Popular Research</div>
     ...
     <button className='  btn btn-block btn-dark'>Write Now</button>
      ...
      <div className='mx-2 my-5' style={{ width: '300px' }}>
        <div className='badge badge-dark py-3 px-5 my-3'>Current Research</div>
        <div className='d-flex'>
          <div
            className='m-2'
            style={{ background: 'grey', height: '75px', width: '100px' }}
